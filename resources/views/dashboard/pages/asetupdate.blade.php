    ...
    <div class="card-body px-5">
        ...
        @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="no" name="no" value="{{ $aset->no }}" required>
            </div>
            <div class="mb-3">
                <label for="jb" class="form-label">Jenis Barang</label>
                <input type="text" class="form-control" id="jb" name="jb" value="{{ $aset->jb }}" required>
            </div>
            <div class="mb-3">
                <label for="kb" class="form-label">Kode Barang</label>
                <input type="text" class="form-control" id="kb" name="kb" value="{{ $aset->kb }}" required>
            </div>
            <div class="mb-3">
                <label for="ib" class="form-label">Identitas Barang</label>
                <input type="text" class="form-control" id="ib" name="ib" value="{{ $aset->ib }}" required>
            </div>
            <div class="mb-3">
                <label for="ab" class="form-label">Asal Usul Barang</label>
                <input type="text" class="form-control" id="ab" name="ab" value="{{ $aset->ab }}" required>
            </div>
            <div class="mb-3">
                <label for="tp" class="form-label">Tahun Perolehan</label>
                <input type="text" class="form-control" id="tp" name="tp" value="{{ $aset->tp }}" required>
            </div>
            <div class="mb-3">
                <label for="kt" class="form-label">Keterangan</label>
                <input type="text" class="form-control" id="kt" name="kt" value="{{ $aset->kt }}" required>
            </div>
            <div class="mb-3">
