    ...
    <div class="row">
        ...
        <div id="footer-atas" class="col-sm-12 mb-3 col-md-4">
            ...
            <ul class="mt-4">
                ...
                <hr>
                <li><a href="https://debest.co.id/">Debest</a></li>
            </ul>
        </div>
        <div class="col-sm-12 mb-3 col-md-4 kanan">
            ...
            <p>
                ...
                Pada saat pembagian Pemerintahan di Bali yang memegang kekuasaan adalah Sri Kresna Kepakisan yang berkedudukan di Srampangan. Mengenai Sejarah Desa Buahan... <div><a class="none" href="/profil">Baca Selengkapnya >></a></div>
            </p>
        </div>
    </div>
</footer>
