        ...
        <section id="about-profil" class="about">
            <div class="about-wrap-profil container-fluid">
                <div class="section-header text-center wow  pb-2" data-aos="zoom-in">
                    ...
                    <h4 class="h4Profile">Br. Buahan Selatan</h4>
                </div>
...
<script>
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            data: [706, 706, 706, 706, 706, 706, 706, 706, 706, 706, 706, 706],
            borderWidth: 3
            },
            {
            label: 'Laki-Laki',
            data: [356, 356, 356, 356, 356, 356, 356, 356, 356, 356, 356, 356],
            borderWidth: 3
            },
            {
            label: 'Perempuan',
            data: [352, 352, 352, 352, 352, 352, 352, 352, 352, 352, 352, 352],
            borderWidth: 3
            },]
        },
        options: {
